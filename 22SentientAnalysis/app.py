...
def generate():
    ...
    completion = openai.Completion.create(engine="text-curie-001", prompt=f"write a long description with a call to action about a {businessType}. Write it using the keywords {keywords}. the name of the business is {businessName} and it's owned by Gonzalo Casas", max_tokens=5)
